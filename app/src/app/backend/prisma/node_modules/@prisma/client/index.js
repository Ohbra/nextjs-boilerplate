...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\brian\\BachelorApp\\bachelor-app\\src\\app\\backend\\prisma\\node_modules\\@prisma\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    ...
    "app/backend/prisma/node_modules/@prisma/client",
  ]
...
path.join(process.cwd(), "src/app/backend/prisma/node_modules/@prisma/client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/app/backend/prisma/node_modules/@prisma/client/schema.prisma")
